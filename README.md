...
Дані зберігаються у статичному JSON-подібному файлі (`src/data/movies.js`) — без бази даних і бекенду.
...
│   ├── data/movies.js             # ← тут додаєш фільми
...
### Перший push (якщо репо ще не на GitHub)

```bash
git init
git add .
git commit -m "Initial commit: alex top films catalog"
git branch -M main
git remote add origin git@github.com:alexDemche/alex-top-films.git
git push -u origin main
```

### Додав нові фільми — оновити сайт
